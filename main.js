...
function CreateTodoElement(item) {
    ...
    const remove_bt_el = document.createElement("button");
    remove_bt_el.classList.add("material-icons", "remove-btn");
    remove_bt_el.innerHTML = "remove_circle";
    
    actions_el.append(edit_btn_el);
    actions_el.append(remove_bt_el);
    ...
    remove_bt_el.addEventListener("click", () => {
    ...
    return { item_el, input_el, edit_btn_el, remove_bt_el}
